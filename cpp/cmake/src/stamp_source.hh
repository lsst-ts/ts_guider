...
struct StampMetadata
{
    ...
    // stamps. A new image issues a new resume; the streaming processor
    // keeps this as a label and resets references on a new START sequence.
    // Empty until the first resume of a series arrives.
    std::string obs_id;
